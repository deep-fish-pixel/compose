...
compose.require(["mod/page/first-page.js?first=true"],function(a){compose.require(["mod/page/second-page.js?"],function(a){alert("second")}),setTimeout(function(){compose.require(["mod/a","mod/b"],function(a,b){alert("third")},["a","b"])},1e3)},["pfirst"]),compose.require(["mod/k"],function(a){alert("first")},["k"]);